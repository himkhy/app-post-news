...
class _MainViewState extends State<MainView> {
  ...
  initState() {
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      Provider.of<NewsViewModel>(context, listen: false).getCategoryArticle(cId,_perPage, _page);
      Provider.of<NewsViewModel>(context, listen: false).getNews(_perPage, _page);
      Provider.of<TagViewModel>(context, listen: false).getTag();
